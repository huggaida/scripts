...
bl_info = {
    ...
    "version": (1, 1),
    "blender": (2, 77, 0),
    "location": "View3D > Specials > C-C Smooth ",
    "warning": "",
    "category": "Mesh",
}
...
In Edit Mode, launch from the "Specials" (W) menu.

Special thanks to:
- This anonymous paste: http://www.pasteall.org/52844/python
- This smoothing tool: https://urchn.org/post/introducing-smooth-tools-better-control-for-smooth-operators
- The Relax script addon
- and StackOverflow users.

Versions:
(1.1) Removed the "edge point" calculation, it wasn't being used anywhere.
(1.0) First version.
