...
def get_python_paths(log):
    ...
    return pythonbinpath, pythonlibpath, ensurepippath, sitepackagespath, usersitepackagespath, easyinstallpath, easyinstalluserpath


def remove_PIL(sitepackagespath, usersitepackagespath, log):
    for sitepath in [sitepackagespath, usersitepackagespath]:
