...
class InstallPIL(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        # get/contruct paths
        pythonbinpath, pythonlibpath, ensurepippath, sitepackagespath, usersitepackagespath, _, _ = get_python_paths(log)

        # before anything is done, check if there are existing PIL/Pillow installatinos, that may prevent our current attempt
        remove_PIL(sitepackagespath, usersitepackagespath, log)
...
class InstallPILAdmin(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        print("\nDECALmachine: Installing PIL (Admin)\n")
        print("Platform:", platform.system())
...
class EasyInstallPILAdmin(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        print("\nDECALmachine: Easy Installing PIL (Admin)\n")
        print("Platform:", platform.system())
        ...
        # get/contruct paths
        pythonbinpath, pythonlibpath, ensurepippath, sitepackagespath, usersitepackagespath, easyinstallpath, easyinstalluserpath = get_python_paths(log)
...
class PurgePIL(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        # get/contruct paths
        _, _, _, sitepackagespath, usersitepackagespath, _, _ = get_python_paths(log)
