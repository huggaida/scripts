...
def register():
    bpy.utils.register_class(PasteVertID)
    bpy.utils.register_class(CopyVertID)
    bpy.utils.register_class(CopySub)
    bpy.utils.register_class(TransferVertId)
...
def unregister():
    bpy.utils.unregister_class(PasteVertID)
    bpy.utils.unregister_class(CopyVertID)
    bpy.utils.unregister_class(CopySub)
    bpy.utils.unregister_class(TransferVertId)
